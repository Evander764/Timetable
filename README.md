...
[点击下载 Windows 安装包 setup.exe](https://github.com/Evander764/Timetable/releases/download/v0.3.1/Timetable-0.3.1-x64-setup.exe)

不想安装时，也可以下载解压版：

[下载 win-unpacked 压缩包](https://github.com/Evander764/Timetable/releases/download/v0.3.1/Timetable-win-unpacked-v0.3.1.zip)
