  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <SettingTile
          title="关闭键隐藏到托盘"
          description="开启后右上角关闭键隐藏到右下角托盘；关闭后彻底退出。"
          control={<Toggle checked={data.appSettings.closeButtonAction === 'tray'} onCheckedChange={(checked) => void updateSettings({ appSettings: { closeButtonAction: checked ? 'tray' : 'quit' } }, checked ? '关闭键将隐藏到托盘。' : '关闭键将彻底退出。')} />}
        />
      </div>
